from qtpy.QtWidgets import QApplication, QAbstractScrollArea, QGraphicsOpacityEffect, QFrame, QWidget, QComboBox, QLabel, QSizePolicy, QDialog, QProgressBar, QMessageBox, QVBoxLayout, QStyle, QSlider, QHBoxLayout, QStyle, QStyleOptionSlider, QColorDialog, QPushButton
from qtpy.QtCore import QEvent, Qt, QPropertyAnimation, QEasingCurve, QTimer, QRect, QRectF, Signal, QPoint, Property, QAbstractAnimation
